...
{% embed url="https://www.youtube.com/watch?v=IRxAY49st1E" %}
...
{% embed url="https://www.youtube.com/watch?v=IOCHMiDh2mQ" %}
...
{% embed url="https://www.youtube.com/watch?v=NK6jpjv-des" %}

Sora:

{% embed url="https://www.youtube.com/watch?v=UAFlf6SF-_Q" %}

Cosmos Predict:

{% embed url="https://www.youtube.com/watch?v=hWOfi2IGxbg" %}
...
{% embed url="https://www.youtube.com/watch?v=V2hm48HPlns" %}
...
{% embed url="https://www.youtube.com/watch?v=kq9WroFR4X8" %}
...
{% embed url="https://www.youtube.com/watch?v=68v7ypUYPfw" %}
...
{% embed url="https://www.youtube.com/watch?v=9oNFXRr7Pf4" %}
...
```
![](../../.gitbook/assets/nvidia-cosmos-predict2-synthetic-data/parking.webp "Parking lot Text2Image-2B")
...
```
![](../../.gitbook/assets/nvidia-cosmos-predict2-synthetic-data/warehouse_docking.webp "Warehouse docking Text2Image-2B")
```bash
PROMPT="Inside an endless water drainage pipe. Point of view of an inspection camera."
```
![](../../.gitbook/assets/nvidia-cosmos-predict2-synthetic-data/drain.webp "Drainage pipe Text2Image-2B")
```bash
...
```
![](../../.gitbook/assets/nvidia-cosmos-predict2-synthetic-data/bike.webp "Bikes Text2Image-2B")
```bash
...
```
![](../../.gitbook/assets/nvidia-cosmos-predict2-synthetic-data/e-scooter.webp "e-scooter Text2Image-2B")
...
![](../../.gitbook/assets/nvidia-cosmos-predict2-synthetic-data/can_factory_batch.png "Batch output")
...
Example results: [batch_can_factory_LLM_enhanced_template.json](https://github.com/eivholt/edgeai-synthetic-cosmos-predict/blob/main/cosmos-predict2/batch_can_factory_LLM_enhanced_template.json)
...
![](../../.gitbook/assets/nvidia-cosmos-predict2-synthetic-data/can_factory_enhanced.webp)
...
For image input, [grounded_sam2_batch_image.py](https://github.com/eivholt/edgeai-synthetic-cosmos-predict/blob/main/labelling-grounded-sam2/grounded_sam2_batch_image.py)
```bash
...
![](../../.gitbook/assets/nvidia-cosmos-predict2-synthetic-data/can_factory_annotated.webp "Labeled images with segmentation masks and bounding boxes")
...
Conversion program: [json_to_pascal_voc.py](https://github.com/eivholt/edgeai-synthetic-cosmos-predict/blob/main/labelling-grounded-sam2/json_to_pascal_voc.py)
```bash
...
![](../../.gitbook/assets/nvidia-cosmos-predict2-synthetic-data/Lambda-Cloud-Launch-Instance.png "Lambda Cloud")
...
```
Resulting video
{% embed url="https://www.youtube.com/watch?v=-GF7wZsc3c8" %}
...
{% embed url="https://www.youtube.com/watch?v=n9JPE182RBc" %}
...
![NVIDIA Cosmos-Predict2-14B-Text2Image demo](../../.gitbook/assets/nvidia-cosmos-predict2-synthetic-data/00231.jpg)
...
![NVIDIA Cosmos-Predict2-14B-Text2Image demo](../../.gitbook/assets/nvidia-cosmos-predict2-synthetic-data/annotated_00003.jpg)

![NVIDIA Cosmos-Predict2-14B-Text2Image demo](../../.gitbook/assets/nvidia-cosmos-predict2-synthetic-data/annotated_00110.jpg)

![NVIDIA Cosmos-Predict2-14B-Text2Image demo](../../.gitbook/assets/nvidia-cosmos-predict2-synthetic-data/annotated_00120.jpg)

![NVIDIA Cosmos-Predict2-14B-Text2Image demo](../../.gitbook/assets/nvidia-cosmos-predict2-synthetic-data/annotated_00163.jpg)

![NVIDIA Cosmos-Predict2-14B-Text2Image demo](../../.gitbook/assets/nvidia-cosmos-predict2-synthetic-data/annotated_00071.jpg)